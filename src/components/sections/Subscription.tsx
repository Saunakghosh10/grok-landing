  ...
  <svg width="310" height="80" viewBox="0 0 310 80" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      ...
      >
        ...
        <feBlend mode="normal" in2="shape" result="effect1_innerShadow_33774_13227" />
      </filter>
      <linearGradient
    ...
    <section className="py-16 sm:py-32 relative overflow-hidden">
      <div className="mx-auto w-full px-4 lg:px-6 xl:max-w-7xl space-y-16 sm:space-y-32">
        <div className="relative flex justify-center items-center py-6">
          <div className="absolute inset-0 h-full w-full -top-16 sm:-top-32">
            <ParticlesCanvas />
          </div>
          <div className="absolute inset-x-0 -top-16 sm:-top-32 h-px bg-gradient-to-r from-transparent via-white to-transparent opacity-40" />
          <div
            className="absolute -inset-x-[200px] lg:-inset-x-[400px] h-[500px] -top-16 sm:-top-32"
            style={{
              background:
              ...
              mask: "radial-gradient(at center top, black, transparent 60%)",
            }}
          />
          <div className="relative space-y-8 flex flex-col items-center text-center max-w-lg">
            <GrokLogo />
            <p className="text-secondary text-lg sm:text-xl">
              Do more with Grok. <br /> Unlock a SuperGrok subscription on Grok.com
            </p>
            <a
              className={cn(
                "relative isolate inline-flex items-center justify-center",
                "border text-base/6 uppercase font-mono tracking-widest shrink-0",
                ...
                "hover:bg-primary/10 hover:border-primary/50 hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.15)]"
              )}
